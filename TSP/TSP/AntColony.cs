...
namespace NearestNeighbor
{
    internal class AntColony
    {
        ...
        //создаем начальных муравьев
        //на выходе - двумерный массив, где первый размер - количество муравьев, второй - номера городов на пути муравья
        ...
        //создаем первоначальный рандомный путь муравья из стартового города в конечный
        private static int[] RandomTrail(int start, int numCities)
        {
            ...
            //перемешиваем города на пути муравья
            for (int i = 0; i <= numCities - 1; i++)
            {
            ...
            //получаем индекс стартового города в перемешанном пути
            ...
            //позвращаем путь муравья, где на первом месте стоит начальный город
            return trail;
        }

        //метод для получения первого города в рандомном списке городов
        ...
        //начальная инициализация феромонов небольшим значением
        ...
        // --------------------------------------------------------------------------------------------
        //Создаем двумерный массив - таблицу неориентированных расстояний между городами
        ...
        //получаем расстояние между указанными 2 городами
